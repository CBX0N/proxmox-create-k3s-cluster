...
module "agent_nodes" {
  ...
  ip_config          = "ip=${var.agent_node_vm_config.ip_prefix}.${var.cluster_config.starting_vmid + count.index}/${var.agent_node_vm_config.subnet_size},gw=${var.agent_node_vm_config.ip_gateway}"
